...
## Input
The first line of input contains an integer n(1≤n≤200000) giving the length of the list. The next n lines each contain an integer between 1 and n+1
 (inclusive), describing the v column of the list.
